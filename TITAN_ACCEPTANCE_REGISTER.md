...
| FRZ-003 | §4 | Locked visual identity (SVG wordmark, fonts, login) | All | N/A | N/A | Partial | N/A | N/A | Partial | N/A | Yes | Staging reports | — | — | Partially implemented | Brand foundation reports exist; full breakpoint audit open | Cursor | UX reports | `TitanWordmark.test.ts`, brand reports |
| FRZ-004 | §5 | Owner Command Centre (quick actions + panels + search) | Owner | Partial | Partial | Partial | Partial | Yes | Partial | Partial | Partial | UX-I partial | Cartrack/Maps | — | Partially implemented | Home KPIs improved; live fleet map + universal search incomplete | Cursor | UX-I | `TITAN_UX_I_STAGING_REPORT.md` |
