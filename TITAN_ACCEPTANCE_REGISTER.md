...
| FRZ-018 | §19 | Integrations truthful provider states | Owner | Yes | Yes | Partial | Yes | Yes | Partial | Yes | Yes | **PARTIAL** — OAuth connected; SCHEDULERS_ENABLED; 49 contacts; no schedule row yet; reconnect Xero for auto-sync hook — Sprint FRZ-018f | **Multi** | OAuth | Partially implemented | OAuth + tenant isolation PASS; schedulers enabled; contacts partial; schedule seed pending | Owner | Sprint FRZ-018f | `TITAN_FRZ018_XERO_STAGING_REPORT.md`, `177-frz018f-auto-sync-schedulers-verify.json` |
