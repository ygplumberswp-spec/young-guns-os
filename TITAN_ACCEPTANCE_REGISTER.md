...
| FRZ-018 | §19 | Integrations truthful provider states | Owner | Yes | Yes | Partial | Yes | Yes | Partial | Yes | Yes | **PARTIAL** — OAuth connected; import running; two-way scaffold queued | **Multi** | OAuth | Partially implemented | OAuth + tenant isolation PASS; background import active; two-way verify after GO | Owner | Sprint 186 | `TITAN_FRZ018_XERO_STAGING_REPORT.md`, `186-xero-two-way-readiness.json` |
