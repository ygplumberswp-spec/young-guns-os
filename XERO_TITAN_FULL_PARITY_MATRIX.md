...
| ACCPAY bills | In Xero | Not imported | — | Payables HOLD | **NO-GO** |
...
| Bank transactions | 3078 sync logs | xero_sync_logs only | read via sync | Integrations | **PARTIAL** — read-only logs |
...
| `/finance/payables` | 3C | **HOLD** — ACCPAY import not wired |
| `/finance/cashflow` | 3D | **PARTIAL GO** — cash vs invoiced separated; bank balance pending |

---

## Known gaps (not blockers for partial Phase 3)
...
4. ACCPAY bills require dedicated import + Payables workspace completion.
5. Migration 0109 full journal entry not committed as applied — staging columns added directly for drift fix.
