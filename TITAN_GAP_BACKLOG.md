...
| **Future (freeze text only)** | Reports & Compliance Agent; Job Document Pack; BOQ Excel/PDF supplier match; freeze §12 OCR/Xero bill match | **Do not implement** until a dedicated freeze batch — **BOQ local foundation started Phase 9** |
