...
const HREF_GROUP: Record<string, NavGroupId> = {
  ...
  '/fleet': 'operations',
  '/fleet-ai-recommendations': 'intelligence',
  ...
  '/voice-ai-receptionist': 'intelligence',
  '/call-intelligence': 'intelligence',
  '/sales-intelligence-agent': 'intelligence',
  '/sales-followup-intelligence': 'intelligence',
  '/sales-analytics-intelligence': 'intelligence',
  '/customer-360-intelligence': 'intelligence',
