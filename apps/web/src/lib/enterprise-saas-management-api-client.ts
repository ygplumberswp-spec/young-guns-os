...
export async function fetchSaasManagementDashboard(accessToken: string) {
  const data = await request<{ dashboard: EnterpriseSaasManagementDashboard }>(
    '/enterprise-saas-management/dashboard',
    {
      accessToken,
    },
  );
...
export async function fetchOwnerBilling(accessToken: string) {
  const data = await request<{ ownerBilling: SmOwnerBillingSummary }>(
    '/enterprise-saas-management/owner-billing',
    {
      accessToken,
    },
  );
...
export async function syncSaasAlerts(accessToken: string) {
  const data = await request<{ saasAlerts: SmSaasAlertSummary[] }>(
    '/enterprise-saas-management/saas-alerts/sync',
    {
      method: 'POST',
      accessToken,
    },
...
export async function captureSaasAnalytics(accessToken: string) {
  const data = await request<{ analytics: unknown }>(
    '/enterprise-saas-management/analytics/capture',
    {
      method: 'POST',
      accessToken,
    },
...
export async function fetchSaasLicenses(accessToken: string) {
  const data = await request<{ licenses: SmLicenseSummary[] }>(
    '/enterprise-saas-management/licenses',
    { accessToken },
  );
...
export async function fetchSaasCoupons(accessToken: string) {
  const data = await request<{ coupons: SmCouponSummary[] }>(
    '/enterprise-saas-management/coupons',
    { accessToken },
  );
  return data.coupons;
}
...
export async function fetchSaasPartners(accessToken: string) {
  const data = await request<{ partners: SmPartnerAccountSummary[] }>(
    '/enterprise-saas-management/partners',
    {
      accessToken,
    },
  );
...
export async function fetchSaasAuditLogs(accessToken: string) {
  ...
  }>('/enterprise-saas-management/audit-logs', { accessToken });
  return data.auditLogs;
}

export async function upgradeSubscription(accessToken: string, planId: string) {
  const data = await request<{ subscription: unknown }>(
    '/enterprise-saas-management/subscriptions/upgrade',
    {
      method: 'POST',
      accessToken,
      body: { planId },
...
export async function downgradeSubscription(accessToken: string, planId: string) {
  const data = await request<{ subscription: unknown }>(
    '/enterprise-saas-management/subscriptions/downgrade',
    {
      method: 'POST',
      accessToken,
      body: { planId },
...
export async function cancelSubscription(accessToken: string) {
  const data = await request<{ subscription: unknown }>(
    '/enterprise-saas-management/subscriptions/cancel',
    {
      method: 'POST',
      accessToken,
    },
