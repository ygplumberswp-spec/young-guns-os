...
const STAFF_ROUTE_REGISTRY: RoutePrefetchEntry[] = [
  ...
  },
  {
    ...
    load: () => import('../pages/driver-intelligence/DriverIntelligencePage'),
  ...
  },
  {
    ...
    load: () => import('../pages/call-intelligence/CallIntelligencePage'),
  ...
  },
  {
    ...
    load: () => import('../pages/sales-followup-intelligence/SalesFollowupIntelligencePage'),
    permissions: ['sales:read', 'sales:write', 'sales_intelligence:read', 'leads:read', 'quotes:read', 'agents:read', '*'],
    experiences: ['platform_owner', 'company_owner', 'staff'],
    priority: 2,
    safeToPreload: true,
  },
  {
    ...
    load: () => import('../pages/sales-analytics-intelligence/SalesAnalyticsIntelligencePage'),
    permissions: ['sales:read', 'sales:write', 'sales_intelligence:read', 'leads:read', 'analytics:read', 'agents:read', '*'],
    experiences: ['platform_owner', 'company_owner', 'staff'],
    priority: 2,
    safeToPreload: true,
  },
  ...
  },
  {
    ...
    load: () => import('../pages/property-intelligence/PropertyIntelligencePage'),
    permissions: ['customers:read', 'customers:write', 'jobs:read', 'documents:read', 'ops:read', 'agents:read', '*'],
    experiences: ['platform_owner', 'company_owner', 'staff'],
    priority: 2,
    safeToPreload: true,
  },
  {
    ...
    load: () => import('../pages/document-intelligence/DocumentIntelligencePage'),
  ...
  },
  {
    ...
    load: () => import('../pages/compliance-intelligence/ComplianceIntelligencePage'),
    permissions: ['legal_compliance:read', 'legal_compliance:write', 'legal_compliance:manage', 'documents:read', 'documents:write', 'agents:read', '*'],
    experiences: ['platform_owner', 'company_owner', 'staff'],
    priority: 2,
    safeToPreload: true,
  },
