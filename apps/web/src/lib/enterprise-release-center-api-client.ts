...
export async function fetchReleaseCenterDashboard(
  accessToken: string,
): Promise<EnterpriseReleaseCenterDashboard> {
  const data = await request<{ dashboard: EnterpriseReleaseCenterDashboard }>(
    '/enterprise-release-center/dashboard',
    {
      accessToken,
    },
  );
...
export async function runIntegrationValidation(accessToken: string) {
  const data = await request<{ run: unknown }>(
    '/enterprise-release-center/integration-validation/run',
    {
      accessToken,
      method: 'POST',
    },
...
export async function runWorkflowValidation(accessToken: string) {
  const data = await request<{ run: unknown }>(
    '/enterprise-release-center/workflow-validation/run',
    {
      accessToken,
      method: 'POST',
    },
...
export async function capturePerformanceSnapshot(accessToken: string) {
  const data = await request<{ snapshot: unknown }>(
    '/enterprise-release-center/performance/capture',
    {
      accessToken,
      method: 'POST',
    },
...
export async function runSecurityVerification(accessToken: string) {
  const data = await request<{ run: unknown }>(
    '/enterprise-release-center/security-verification/run',
    {
      accessToken,
      method: 'POST',
    },
...
export async function runConfigurationReview(accessToken: string) {
  const data = await request<{ review: unknown }>(
    '/enterprise-release-center/configuration-review/run',
    {
      accessToken,
      method: 'POST',
    },
...
export async function generateReleaseReport(accessToken: string) {
  const data = await request<{ report: unknown }>(
    '/enterprise-release-center/release-report/generate',
    {
      accessToken,
      method: 'POST',
    },
...
export async function syncReleaseCenterAlerts(accessToken: string) {
  const data = await request<{ platformAlerts: unknown[] }>(
    '/enterprise-release-center/platform-alerts/sync',
    {
      accessToken,
      method: 'POST',
    },
...
export async function captureReleaseCenterAnalytics(accessToken: string) {
  const data = await request<{ analytics: unknown }>(
    '/enterprise-release-center/analytics/capture',
    {
      accessToken,
      method: 'POST',
    },
...
export async function fetchReleaseCenterAuditLogs(
  accessToken: string,
): Promise<RcAuditLogSummary[]> {
  const data = await request<{ auditLogs: RcAuditLogSummary[] }>(
    '/enterprise-release-center/audit-logs',
    {
      accessToken,
    },
  );
