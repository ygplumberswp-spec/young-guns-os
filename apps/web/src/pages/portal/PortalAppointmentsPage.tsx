...
import { PortalApiClientError, fetchPortalAppointments, createPortalRequest, createCxPortalBooking, fetchCxPortalBookings } from '../../lib/portal-api-client';
...
export function PortalAppointmentsPage() {
  ...
  return (
    <div className="portal-page">
      <PageHeader title="Appointments" description="Book appointments, view confirmations, and request changes." />
      ...
      <Panel title="Book an appointment">
        <div className="form-stack">
          ...
          />
          <textarea placeholder="Job notes" value={jobNotes} onChange={(e) => setJobNotes(e.target.value)} rows={3} />
