...
export const JobProcurementChainPage = lazyNamed(
  () => import('../pages/finance/JobProcurementChainPage'),
  'JobProcurementChainPage',
);
...
export const JobCostControlPage = lazyNamed(
  () => import('../pages/finance/JobCostControlPage'),
  'JobCostControlPage',
);
export const BankControlPage = lazyNamed(
  () => import('../pages/finance/BankControlPage'),
  'BankControlPage',
);
export const CashControlPage = lazyNamed(
  () => import('../pages/finance/CashControlPage'),
  'CashControlPage',
);
export const OwnerFinancialCommandPage = lazyNamed(
  () => import('../pages/finance/OwnerFinancialCommandPage'),
  'OwnerFinancialCommandPage',
);
export const ProfitAnalyticsPage = lazyNamed(
  () => import('../pages/finance/ProfitAnalyticsPage'),
  'ProfitAnalyticsPage',
);
export const OperatingProfitPage = lazyNamed(
  () => import('../pages/finance/OperatingProfitPage'),
  'OperatingProfitPage',
);
export const BudgetControlPage = lazyNamed(
