...
export const TITAN_API_EXPLORER_ENDPOINTS: DeveloperApiExplorerEndpoint[] = [
  ...
  {
    method: 'GET',
    path: '/api/v1/integration-platform/dashboard',
    summary: 'Integration platform dashboard',
    tag: 'Integrations',
    requiredPermissions: ['integrations:read'],
  },
  {
    method: 'GET',
    path: '/api/v1/mission-control/dashboard',
  ...
  {
    method: 'GET',
    path: '/api/v1/evolution/dashboard',
    summary: 'Evolution dashboard',
    tag: 'Evolution',
    requiredPermissions: ['intelligence:read'],
  },
  {
    method: 'GET',
    path: '/api/v1/developer-platform/dashboard',
    summary: 'Developer platform dashboard',
    tag: 'Developer',
  ...
  return [
    {
      ...
      description:
        'Initial developer platform with API explorer, SDK generation, webhooks, and extension framework.',
      changeType: 'feature',
