...
import { createGrowthPlannerRouter } from './routes/growth-planner.js';
...
import { GrowthPlannerService } from './services/growth-planner.service.js';
...
const boqReviewedExportService = new BoqReviewedExportService(db);
...
const financeReceiptReconciliationService = new FinanceReceiptReconciliationService(
  db,
  jobProfitabilityService,
  jobCostControlService,
);
const cashControlService = new CashControlService(db, jobProfitabilityService);
const ownerFinancialCommandService = new OwnerFinancialCommandService(
  db,
  cashControlService,
  jobCostControlService,
);
const profitAnalyticsService = new ProfitAnalyticsService(db);
const operatingProfitService = new OperatingProfitService(
  cashControlService,
  profitAnalyticsService,
);
const budgetControlService = new BudgetControlService(db, operatingProfitService);
const growthPlannerService = new GrowthPlannerService(
  db,
