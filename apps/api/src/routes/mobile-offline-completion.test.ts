...
function buildApp(services: {
  ...
  app.use(
    ...
    createMobileRouter({
      ...
      jobVisitsService: {
        ensureOpenVisit: async () => undefined,
        stillBusy: async () => ({}),
        requestReschedule: async () => ({}),
        approveReschedule: async () => ({}),
        listVisits: async () => [],
        getRollup: async () => ({}),
        closeOpenVisitOnCompletion: async () => null,
        buildAttentionExtras: async () => [],
      } as unknown as import('../services/job-visits.service.js').JobVisitsService,
      quickJobIntakeService: {
        matchByPhone: async () => [],
        technicianQuickAdd: async () => ({}),
        prepareOwnerQuickCall: async () => ({}),
        ownerQuickCallCreate: async () => ({}),
        confirmTechnicianIntake: async () => ({}),
        listPendingConfirmations: async () => [],
      } as unknown as import('../services/quick-job-intake.service.js').QuickJobIntakeService,
